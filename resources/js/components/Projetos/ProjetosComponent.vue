...
<v-app>
    <div id="container">
        ...
        <v-bottom-sheet v-model="edicoesSheet">
            <projeto-edicoes-component ref="projetoEdicoesComponent" :projetoAtual="projetoAtual" :formSheet="formSheet" @fechar="onClickCloseBSheet"></projeto-edicoes-component>
        </v-bottom-sheet>
        ...
        watch: {
            edicoesSheet: function () {
                if (this.edicoesSheet == false) {
                    // alert(this.$refs.projetoEdicoesComponent.openFormDialog);
                    this.$refs.projetoEdicoesComponent.openFormDialog = false;
                }
            }
        },
    }
