...
@section('title', 'Terra do Sol - '.$edicao->title.' - Vídeos - Editar')
@section('content')
<h1>Terra do Sol - {{ $edicao->title }} &raquo; Vídeos - Editar</h1>
    <form action="{{ route('backend.ts.videos.update', ['edicao' => $edicao->id, 'id' => $record->id]) }}" class="form form-vertical" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="col-sm-4 text-center">
                            <div class="kv-avatar">
                                <div class="file-loading">
                                    <input id="file" name="feature_image" type="file">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="video" id="video" value="{{ $record->video }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
var defaultImg = "{{asset('storage')}}/{{$record->path}}original-{{$record->thumbnail}}";
$("#file").fileinput({
    ...
    defaultPreviewContent: '<img src="'+defaultImg+'" alt="Vídeo" class="img-fluid">',
