                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" value="{{ $record->title }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
...
var defaultImg = "{{asset('storage')}}/{{$record->path}}original-{{$record->logo}}";
$("#file").fileinput({
    ...
    defaultPreviewContent: '<img src="'+defaultImg+'" alt="Logo" class="img-fluid">',
