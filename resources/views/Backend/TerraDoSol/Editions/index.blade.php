                        ...
                        <tbody>
                            @foreach($records as $record)
                                <tr>
                                    ...
                                    <th scope="row">
                                        <a href="{{route('backend.ts.editions.edit', ['equipe' => $record->id])}}" class="btn btn-warning btn-sm">
                                            <i class="fa fa-pencil"></i> 
                                            Editar
                                        </a>
                                        <form  method="POST" action="{{route('backend.ts.editions.destroy', ['equipe' => $record->id])}}" style="display:inline-block">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
