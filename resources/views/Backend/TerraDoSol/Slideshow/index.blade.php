...
@section('title', 'Terra do Sol - '.$edicao->title.' - Slideshow')
@section('content')
    <h1>Terra do Sol - {{ $edicao->title }} &raquo; Slideshow</h1>
        <div class="row">
...
$(document).ready(function() {
    $("#file-1").fileinput({
        ...
        @endif
        language: "pt-BR",
        uploadUrl: "{{ route('backend.ts.slideshow.store', ['edicao' => $edicao->id]) }}",
        deleteUrl: "{{ route('backend.ts.slideshow.destroy') }}",
