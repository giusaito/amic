		...
		<div class="col-md-9 mt-3">
			...
			<div class="card mt-3" style="padding:15px;">
				...
				<div class="form-group">
					...
					<textarea class="form-control editor" name="content" id="content" rows="15" data-height="400">{{old('content', $tv->content)}}</textarea>
		...
		<div class="col-md-3 mt-3">
			...
			<div class="card">
				...
				<div class="card-block">
					<input type="file" name="feature_image" class="dropify" data-allowed-file-extensions="jpeg jpg png"  data-max-file-size="1M" @if($tv->path) value="{{asset('storage')}}/{{$tv->path}}original-{{$tv->image}}" data-default-file="{{asset('storage')}}/{{$tv->path}}original-{{$tv->image}}" @endif/>
					<input type="hidden" name="isPhoto" id="isPhoto" value="{{!empty($tv->path) ? 1 : 0}}">
				</div>
			</div>
		</div>
	</div>
