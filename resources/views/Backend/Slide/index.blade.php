            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="ibox-title">
                        <h5>Lista de Slides cadastrados</h5>
                        <div class="ibox-tools">
                            <a href="{{route('backend.slide.create')}}/" class="btn btn-primary btn-sm right">
