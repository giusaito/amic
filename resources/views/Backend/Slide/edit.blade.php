			...
			<div class="card mt-3 mb-3">
				<div class="card-header">
					...
					<div class="card-block p-3">
						<input type="file" id="photo" name="feature_image" class="dropify" data-allowed-file-extensions="jpeg jpg png"  data-max-file-size="1M" @if($record->path) value="{{asset('storage')}}/{{$record->path}}original-{{$record->image}}" data-default-file="{{asset('storage')}}/{{$record->path}}original-{{$record->image}}" @endif/>
