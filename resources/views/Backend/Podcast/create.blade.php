		...
		<div class="col-md-9 mt-3">
			...
			<div class="card mt-3" style="padding:15px;">
				<div class="form-group">
					...
					<input name="title" type="text" class="form-control" id="title" placeholder="Título do Podcast" required="required">
				</div>
				<div class="form-group">
					<label for="description">Descrição</label>
					<input name="description" type="text" class="form-control" id="description" placeholder="Descrição curta do Podcast" required="required">
				</div>
				<div class="form-group">
					<label for="iframe">Iframe</label>
					<input name="iframe" type="text" class="form-control" id="iframe" placeholder="Iframe do Podcast" required="required">
				</div>
				<div class="form-group">
