...
@section('title', 'Categorias site úteis')
@section('content')

<section id="sitesUteis">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2>Categorias sites úteis</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/painel">Painel</a>
                </li>
                <li class="breadcrumb-item active">
                    <strong>Categorias sites úteis</strong>
                </li>
            </ol>
        </div>  
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="ibox-title">
                        <h5>Lista de categorias de sites úteis cadastrados</h5>
        ...
        <div class="row">
            <div class="row">
                <div class="mx-auto d-block">
                    @include('Backend.Includes.pagination', ['paginator' => $categorySites])
                </div>
            </div>
        </div>  
    </div>
