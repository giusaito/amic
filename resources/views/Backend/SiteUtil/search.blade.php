...
@section('title', 'Site Útil Amic')
@section('content')

<section id="tvAmic">
    <div class="text-right mt-4">
        <a href="{{route('backend.site-util.index')}}/" class="btn btn-warning right"><i class="fa fa-chevron-left"></i> Voltar</a>
    </div>
    ...
    <div class="container-fluid">
	                    ...
	                    <tbody>
	                        @foreach($siteUtils as $siteUtil)
	                            <tr>
	                                ...
	                                <th scope="row">
	                                    <a href="{{route('backend.site-util.edit', ['site_util' => $siteUtil->id])}}" class="btn btn-white btn-sm">
        ...
        <div class="row">
        	<div class="mx-auto d-block">
        		{{ $siteUtils->withQueryString()->onEachSide(3)->links() }}
        	</div>
        </div>
    </div>
</section>
