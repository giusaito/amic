			...
			<div class="card mt-3 mb-3">
				<div class="card-header">
					...
					<div class="card-block p-3">
	                    ...
	                    <input type="text" class="form-control datetimepicker-input" name="published_at" data-target="#datetimepicker1"/ value="{{date("d/m/Y H:i", strtotime($siteUtil->published_at))}}">
			...
			<div class="card mt-3 mb-3">
				...
				<div class="card-block p-3">
					<select name="status" id="status" class="form-control" required="required">
						...
						<option value="PUBLISHED" {{ ($siteUtil->status == 'PUBLISHED' ? "selected":"") }}>Publicado</option>
						<option value="DRAFT" {{ ($siteUtil->status == 'DRAFT' ? "selected":"") }}>Rascunho</option>
					</select>
