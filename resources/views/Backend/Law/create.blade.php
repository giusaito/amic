...
@section('title', 'Adicionar Leis & Regimentos')
@section('content')
...
<form action="{{ route('backend.lei.store') }}" class="form-bordered" method="post" enctype="multipart/form-data">
	@csrf
	<div class="row">
		<div class="col-md-9 mt-3">
			...
			<div class="card mt-3" style="padding:15px;">
				...
				<div class="form-group">
					...
					<input name="description" type="text" class="form-control" id="description" placeholder="Descrição curta">
				</div>
				<div class="form-group">
					<label for="url">Url</label>
					<input name="url" type="url" class="form-control" id="url" placeholder="Insira a URL">
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 mt-3">
			...
			<div class="card mt-3 mb-3">
				<div class="card-header">
					...
					<div class="card-block p-3">
						<input id="archive" type="file" name="archive" class="dropify" data-allowed-file-extensions="pdf xlsx xltx excel word"  data-max-file-size="1M"/>
					</div>
				</div>
		</div>
	</div>
