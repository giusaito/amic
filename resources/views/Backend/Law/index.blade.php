...
<section id="RecordAmic">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2>Leis & Regimentos AMIC</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/painel">Painel</a>
                </li>
                <li class="breadcrumb-item active">
                    <strong>Leis & Regimentos Amic</strong>
                </li>
            </ol>
        </div>  
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="ibox-title">
                        <h5>Lista de Leis & Regimentos cadastrados</h5>
                        <div class="ibox-tools">
                            <a href="{{route('backend.lei.create')}}/" class="btn btn-primary btn-sm right">
